...
const CoursesPage: React.FC = () => {
  ...
  const sampleCourses: Course[] = [
    {
      ...
      description: 'Master MongoDB, Express.js, React, and Node.js to build full-stack web applications. This comprehensive course covers everything from basics to advanced concepts with hands-on projects.',
      shortDescription: 'Learn to build complete web applications using the MERN stack',
      ...
      price: { original: 2999, discounted: 1999, currency: 'INR', isFree: false },
      ...
      features: ['Video Lectures', 'Hands-on Projects', 'Certificate', 'Lifetime Access', 'Community Support'],
      language: 'English',
    ...
    },
    {
      ...
      description: 'Start your programming journey with JavaScript. Learn variables, functions, objects, and DOM manipulation through interactive exercises and real-world examples.',
    ...
    },
    {
      ...
      description: 'Take your React skills to the next level with advanced patterns, performance optimization techniques, and modern React features like Suspense and Concurrent Mode.',
      shortDescription: 'Master advanced React concepts and optimization techniques',
      thumbnail: 'https://images.unsplash.com/photo-1633356122102-3fe601e05bd2?w=500',
      provider: {
        name: 'Coursera',
      ...
      features: ['Video Lectures', 'Peer Reviews', 'Certificate', 'Mobile Access'],
      language: 'English',
    ...
    },
    {
      ...
      description: 'Build robust backend applications with Node.js and Express. Learn authentication, database integration, API design, testing, and deployment strategies.',
      ...
      price: { original: 84.99, discounted: 12.99, currency: 'USD', isFree: false },
      ...
      features: ['Video Lectures', 'Coding Exercises', 'Certificate', 'Lifetime Access'],
      language: 'English',
  ...
  useEffect(() => {
    ...
    const savedWishlist = JSON.parse(localStorage.getItem('course_wishlist') || '[]');
  ...
  useEffect(() => {
    ...
    if (selectedProvider !== 'all') {
      filtered = filtered.filter(course => course.provider.name === selectedProvider);
    }
  ...
  }, [courses, searchQuery, selectedCategory, selectedLevel, selectedProvider, priceFilter, sortBy]);
  ...
  const toggleWishlist = (courseId: string) => {
    ...
    localStorage.setItem('course_wishlist', JSON.stringify(Array.from(newWishlist)));
  };
  ...
  const enrollInCourse = (course: Course) => {
    ...
    localStorage.setItem('enrolled_courses', JSON.stringify(Array.from(newEnrollments)));
  ...
  const getProviderColor = (provider: string) => {
    switch (provider.toLowerCase()) {
      case 'guvi': return 'bg-purple-100 text-purple-700';
      case 'coursera': return 'bg-blue-100 text-blue-700';
      case 'udemy': return 'bg-orange-100 text-orange-700';
      case 'freecodecamp': return 'bg-green-100 text-green-700';
      default: return 'bg-gray-100 text-gray-700';
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-indigo-100 mb-8 max-w-3xl mx-auto">
              Learn from industry experts with courses from Guvi, Coursera, Udemy, and more. 
              Build real projects and advance your career in tech.
            </p>
          ...
          {filteredCourses.map((course) => (
            ...
            >
              ...
              <div className={`relative ${viewMode === 'list' ? 'w-64 flex-shrink-0' : 'aspect-video'}`}>
                ...
                >
                  <Heart className={`w-4 h-4 ${wishlist.has(course._id) ? 'fill-red-500 text-red-500' : 'text-gray-600'}`} />
                </button>
              ...
              <div className="p-6 flex-1">
                ...
                <div className="flex items-center justify-between mb-3">
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${getProviderColor(course.provider.name)}`}>
                  ...
                  <div>
                    {course.price.isFree ? (
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`${course.price.discounted ? 'text-sm text-gray-500 line-through' : 'text-2xl font-bold text-indigo-600'}`}>
